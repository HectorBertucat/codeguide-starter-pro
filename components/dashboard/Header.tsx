...
export default function Header({ user }: HeaderProps) {
  ...
  return (
    <header className="border-b border-gray-200 bg-white">
      <div className="flex h-16 items-center justify-between px-4 md:px-6">
        ...
        <div className="hidden md:block">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder={`Search (Logged in as ${user.role})`}
      ...
      {/* Mobile sidebar - Render actual Sidebar component */}
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-40 md:hidden">
          ...
          ></div>
          {/* Sidebar Drawer */}
          <div className="fixed inset-y-0 left-0 z-50 w-64 transform transition duration-300 ease-in-out">
            <div className="flex h-full flex-col overflow-y-auto bg-white shadow-xl">
              ...
              {/* Render the actual Sidebar navigation */}
              {/* We need to pass the userRole prop here as well */}
              {/* Assuming the role is available via the user prop passed in */}
